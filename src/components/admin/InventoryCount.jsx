                  ...
                  <Table>
                    ...
                    <TableBody>
                      {products.filter(p => p.type === cat.value).map(product => {
                        ...
                        return (
                          <TableRow key={product.id}>
                            ...
                            <TableCell className="text-slate-500">{product.safety_stock ?? '—'}</TableCell>
                            <TableCell className="text-slate-500">{product.cost_per_unit ?? '—'}</TableCell>
                      ...
                      {products.filter(p => p.type === cat.value).length === 0 && (
                        <TableRow>
                          <TableCell colSpan={9} className="text-center text-slate-400 py-6">Inga artiklar i denna kategori</TableCell>
                        </TableRow>
                      )}
                    </TableBody>
                  </Table>
